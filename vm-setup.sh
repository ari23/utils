...
sudo -E apt-get -q install -y cmake mg make git linux-headers-$(uname -r) clang-format \
                              pkg-config linux-modules-extra-$(uname -r) xauth xterm \
                              ...
                              qttools5-dev-tools ntp swapspace
